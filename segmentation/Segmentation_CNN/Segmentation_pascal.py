...
def similarity(mask_query_img ):
    count=0
    similarity=[]
    #### DIMENSIONALITY REDUCTION FOR QUERY IMAGE #######
    mask_query_img = np.resize(mask_query_img,(128,128))
    ...
    for iter in range(len(features)):
        ...
        row=[file_name[iter],sim_ssim , labels[iter]]
...
if __name__ == "__main__":    
    ...
    mask_query_img , predict_flat_query_img = extract_features(img) 

    similarity=similarity( mask_query_img )
