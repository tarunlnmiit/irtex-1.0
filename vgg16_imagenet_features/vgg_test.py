...
from VGG16FeatureExractor import VGG16FeatureExtractor, extract_feature_vgg
import os
from sklearn.metrics.pairwise import cosine_similarity

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='VGG16 imagenet Extractor Test')
    ...
    if test_image:
        try:
            feature = extract_feature_vgg(test_image)
    ...
    for file in tqdm(os.listdir(path)):
        descriptor = extract_feature_vgg(os.path.join(path, file))
